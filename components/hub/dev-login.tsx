  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full sm:w-auto inline-flex min-h-11 items-center justify-center rounded-[2px] bg-accent px-6 text-[15px] font-bold text-on-accent transition-all duration-75 hover:brightness-110 disabled:opacity-50"
      >
