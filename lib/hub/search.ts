 ...
 *
 * The filler verbs matter more than they look. A typed query is usually a noun
 * ("bookshelf"), but a spoken one is a sentence — "something to help me with
 * building flat-pack furniture" — and the phrase logic below stops at the
 * first connector whose preceding words look meaningful. Without "help" here,
 * that query stops at "with" and searches for the word "help", throwing away
 * every word that actually named the thing.
 */
const NOISE = new Set([
  "a", "an", "the", "and", "or", "for", "my", "me", "some", "any", "need", "needs", "want", "wants",
  "looking", "i", "im", "to", "of", "in", "on", "with", "something", "somewhere", "thing", "please",
  "help", "helps", "helping", "get", "getting", "find", "finding", "use", "using", "do", "does",
  "can", "could", "would", "should", "is", "are", "am", "be", "have", "has", "it", "its", "this",
  "there", "here", "how", "what", "where", "anything", "someone", "somebody", "please", "just", "at",
]);
...
const DESCRIPTORS = new Set([
  ...
  "new", "used", "old", "quiet", "simple", "basic", "extra", "spare", "another",
